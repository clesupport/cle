...
$string['configtitle'] = 'NephilaMobile';
$string['pluginname'] = 'NephilaMobile';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>NephilaMobile</h2>
<p><img class=img-polaroid src="nephilamobile/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About NephilaMobile</h3>
<p>NephilaMobile is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
$string['custommenuitems1'] = 'This custom menu for CLETeacher';
$string['custommenuitems2'] = 'This custom menu for Student';
$string['custommenuitems3'] = 'This custom menu for User and Course Creator';
$string['custommenuitems4'] = 'This custom menu for School Administrator';
$string['custommenuitemheading'] = 'Custom Menu Items';
$string['faq'] = 'FAQ\'s';
$string['adminannouncement'] = 'Announcement';
$string['adminnews'] = 'News';
$string['privatefiles'] = 'My Files';
$string['studentmenu'] = 'My Menu';
$string['teachermenu'] = 'My Menu';
...
$string['logstoday'] = 'Logs Today';
$string['alllogs'] = 'All Logs';
$string['sumassessreport'] = 'Summary Assessment Report';
$string['subassessreport'] = 'Subject Assessment Report';
$string['mylearningwall'] = 'My Learning Wall';
$string['myachievements'] = 'My Achievements';
$string['assessmtreport'] = 'Assessment Report';
$string['sumassess'] = 'Summary Assessment';
$string['subsumassess'] = 'Subject Summary Assessment';
$string['users'] = 'Users';
$string['accounts'] = 'Accounts';
$string['browselistofusers'] = 'Browse list of users';
$string['bulkuseraction'] = 'Bulk users action';
$string['addnewusers'] = 'Add new user';
$string['cohorts'] = 'Cohorts';
$string['uploadusers'] = 'Upload users';
$string['uploaduserspicture'] = 'Upload users picture';
...
/* Custom Menu Items*/
$string['custommenuitemheading'] = 'Custom Menu Item';
$string['custommenuitemheadingsub'] = 'Add different custommenu per course or user.';
$string['custommenuitemdesc'] = 'Settings here allow you to add new dynamic functionality to the custommenu';
...
$string['slide6'] = 'Slide Six';
$string['slide7'] = 'Slide Seven';
$string['slide8'] = 'Slide Eight';
$string['slide9'] = 'Slide Nine';
$string['slide10'] = 'Slide Ten';
