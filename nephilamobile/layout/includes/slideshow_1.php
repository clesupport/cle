...
?>
    ...
    <?php if ($hasslide1) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide1url) { ?>
                <a href="<?php echo $slide1url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide2) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide2url) { ?>
                <a href="<?php echo $slide2url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide3) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide3url) { ?>
                <a href="<?php echo $slide3url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide4) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide4url) { ?>
                <a href="<?php echo $slide4url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
	...
	?>
     ...
     <?php if ( $hasslide5 ) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide5url) { ?>
                <a href="<?php echo $slide5url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
    ...
    <?php if ( $hasslide6 ) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide6url) { ?>
                <a href="<?php echo $slide6url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
    ...
    <?php if ( $hasslide7 ) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide7url) { ?>
                <a href="<?php echo $slide7url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
    ...
    <?php if ( $hasslide8 ) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide8url) { ?>
                <a href="<?php echo $slide8url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
    ...
    <?php } ?>
     ...
     <?php if ( $hasslide9 ) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide9url) { ?>
                <a href="<?php echo $slide9url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
   ...
   <?php if ( $hasslide10 ) { ?>
        <div class="da-slide">
            ...
            <?php if ($hasslide10url) { ?>
                <a href="<?php echo $slide10url ?>" class="da-link"><?php echo get_string('readmore','theme_nephilamobile')?></a>
            <?php } ?>
