global $USER, $COURSE, $PAGE;
	...
	if($schoolrole == 'cleteacher') {
		       ...
		       $branchsort  = 100000;
			    ...
			    $branch = $menu->add($branchlabel, $branchurl, $branchtitle, $branchsort);
			    $branch->add('<em><i class="fa fa-sign-in"></i>'.get_string('managebadges', 'theme_nephilamobile').'</em>',new moodle_url('/badges/index.php', array('type' => 2, 'id' => $COURSE->id)),get_string('managebadges', 'theme_nephilamobile'));
		       $branch->add('<em><i class="fa fa-plus-square icon-small"></i>'.get_string('addnewbadge', 'theme_nephilamobile').'</em>',new moodle_url('/badges/newbadge.php', array('type' => 2, 'id' => $COURSE->id)),get_string('addnewbadge', 'theme_nephilamobile'));
		       ...
		       $branchsort  = 1000000;
			    ...
			    $branch = $menu->add($branchlabel, $branchurl, $branchtitle, $branchsort);
			    $branch->add('<em><i class="fa fa-question"></i>'.get_string('questions', 'theme_nephilamobile').'</em>',new moodle_url('/question/edit.php', array('courseid' => $COURSE->id)),get_string('questions', 'theme_nephilamobile'));
				 $branch->add('<em><i class="fa fa-bookmark-o"></i>'.get_string('categories', 'theme_nephilamobile').'</em>',new moodle_url('/question/category.php', array('courseid' => $COURSE->id)),get_string('categories', 'theme_nephilamobile'));
				 $branch->add('<em><i class="fa fa-download"></i>'.get_string('import', 'theme_nephilamobile').'</em>',new moodle_url('/question/import.php', array('courseid' => $COURSE->id)),get_string('import', 'theme_nephilamobile'));
				 $branch->add('<em><i class="fa fa-upload"></i>'.get_string('export', 'theme_nephilamobile').'</em>',new moodle_url('/question/export.php', array('courseid' => $COURSE->id)),get_string('export', 'theme_nephilamobile'));	
		       ...
		       $branch = $menu->add($branchlabel, $branchurl, $branchtitle, $branchsort);
		       $branch->add('<em><i class="fa fa-file"></i>'.get_string('activitycompletion', 'theme_nephilamobile').'</em>',new moodle_url('/report/progress/index.php', array('course' => $COURSE->id)),get_string('activitycompletion', 'theme_nephilamobile'));
		       $branch->add('<em><i class="fa fa-file"></i>'.get_string('logstoday', 'theme_nephilamobile').'</em>',new moodle_url('/report/log/user.php?', array('id' => $USER->id, 'course' => $COURSE->id, 'mode' => 'today')),get_string('logstoday', 'theme_nephilamobile'));
		       $branch->add('<em><i class="fa fa-file"></i>'.get_string('alllogs', 'theme_nephilamobile').'</em>',new moodle_url('/report/log/user.php?', array('id' => $USER->id, 'course' => $COURSE->id, 'mode' => 'all')),get_string('alllogs', 'theme_nephilamobile'));
		       $branch->add('<em><i class="fa fa-file"></i>'.get_string('sumassessreport', 'theme_nephilamobile').'</em>',new moodle_url('/grade/report/grader/index.php', array('id' => $COURSE->id)),get_string('sumassessreport', 'theme_nephilamobile'));
		       $branch->add('<em><i class="fa fa-file"></i>'.get_string('subassessreport', 'theme_nephilamobile').'</em>',new moodle_url('/grade/report/user/index.php', array('id' => $COURSE->id)),get_string('subassessreport', 'theme_nephilamobile'));
