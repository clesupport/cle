...
if (strpos($checkuseragent, 'MSIE 7')) {
	echo get_string('ie7message', 'theme_nephilamobile');
}?>
...
<p>
                <img src ="
		<?php echo $CFG->wwwroot . "/nephilaIMG/" . profile_user_record($USER->id)->schoologo;?> 
                " alt="School Logo" width="60" height="60" align="left"/>
		<!--
                <i id="headerlogo" class="fa fa-<?php echo $PAGE->theme->settings->siteicon ?>">
                 </i>-->
                <?php if ($hastagline) { ?>
		<!--
		...
		-->                
		<?php } else { ?>
                	<h1 id="title" style="line-height: 2em;text-indent:0.5em;"><?php echo profile_user_record($USER->id)->schoolname; ?></h1></p>
                <?php } ?>
        ...
        <div class=""  style="float:left; width:20%" id="profilepic" >
        <div style="float:left; width:65%; text-align:right; padding-right:5px">

	<?php if(strcmp(profile_user_record($USER->id)->schoolrole,"student")==0){ ?>

	     <p id=""><b><?php echo $USER->firstname ." ". $USER->lastname; ?></b><br>
		<?php echo profile_user_record($USER->id)->level;?>
                <br/>
                <?php echo profile_user_record($USER->id)->section; ?>
		</p>
	<?php } else {?>

		 <p id=""><b><?php echo $USER->firstname ." ". $USER->lastname; ?></b><br>
		<?php echo profile_user_record($USER->id)->position;?>
               		</p>
	...
	<?php }?>
        ...
        <p id="socialheading"><?php echo get_string('socialnetworks','theme_nephilamobile')?></p>
        ...
        <p id="socialheading"><?php echo get_string('mobileappsheading','theme_nephilamobile')?></p>
            <ul class="socials unstyled">
                <?php if ($hasios) { ?>
