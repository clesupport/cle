...
//$OUTPUT->is_in_frontpage($FRONTPAGE_LAYOUT);
...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/nephila/style/nojs.css" />
	</noscript>
    	<style>
	div.buttons div.singlebutton{ display: none;}
	</style>
        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
               <?php echo $OUTPUT->custom_menu(); ?>
					<?php //require_once(dirname(__FILE__).'/includes/menucreator.php'); ?>
...
<!-- End Frontpage Content -->
	...
	<div class="hidden-blocks">
    	<div class="row-fluid">
        	<h4><?php echo get_string('visibleadminonly', 'theme_nephilamobile') ?></h4>
            <?php
                echo $OUTPUT->nephilablocks('hidden-dock');
            ?>
    	</div>
	</div>
	<?php } ?>
