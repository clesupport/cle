 ...
 */
function theme_nephilamobile_set_fontwww($css) {
    global $CFG, $PAGE;
 ...
 */
function theme_nephilamobile_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_nephilamobile_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @return string
 */
    function nephilamobile_set_pagewidth($css, $pagewidth) {
 ...
 * @return string
 */
function nephilamobile_set_editicons($css, $editicons) {
	global $CFG;
	if (!empty($CFG->themedir)) {
		$editiconsurl = $CFG->themedir . '/nephilamobile/style/editicons.css'; //Pull the full path for autohide css
	} else {
		$editiconsurl = $CFG->dirroot . '/theme/nephilamobile/style/editicons.css'; //MDL-36065
	}
 ...
 * @return string
 */
function nephilamobile_performance_output($param) {
 ...
 */
function nephilamobile_set_customcss($css, $customcss) {
...
function theme_nephilamobile_process_css($css, $theme) {
    ...
    $css = nephilamobile_set_pagewidth($css,$pagewidth);
    ...
    $css = theme_nephilamobile_set_headingfont($css, $headingfont);
    $css = theme_nephilamobile_set_bodyfont($css, $bodyfont);
    $css = theme_nephilamobile_set_bodysize($css, $bodysize);
    $css = theme_nephilamobile_set_bodyweight($css, $bodyweight);
    ...
    $css = theme_nephilamobile_set_themecolor($css, $themecolor);
    ...
    $css = theme_nephilamobile_set_themehovercolor($css, $themehovercolor);
    ...
    $css = theme_nephilamobile_set_footercolor($css, $footercolor);
    ...
    $css = theme_nephilamobile_set_footersepcolor($css, $footersepcolor);
    ...
    $css = theme_nephilamobile_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_nephilamobile_set_footerurlcolor($css, $footerurlcolor);
    ...
    $css = theme_nephilamobile_set_footerhovercolor($css, $footerhovercolor);
...
// Set the footer heading color.
    ...
    $css = theme_nephilamobile_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_nephilamobile_set_slideheadercolor($css, $slideheadercolor);
    ...
    $css = theme_nephilamobile_set_slidecolor($css, $slidecolor);
    ...
    $css = theme_nephilamobile_set_slidebuttoncolor($css, $slidebuttoncolor);
    ...
    $css = theme_nephilamobile_set_navbarsep($css, $navbarsep);
    ...
    $css = nephilamobile_set_editicons($css, $editicons);
    ...
    $css = nephilamobile_set_customcss($css, $customcss);

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_nephilamobile_set_logo($css, $logo);
    
    // Set the background image for the page.
    $setting = 'pagebackground';
    $pagebackground = $theme->setting_file_url($setting, $setting);
    $css = theme_nephilamobile_set_pagebackground($css, $pagebackground, $setting);
    ...
    $css = theme_nephilamobile_set_slideimage($css, $slideimage, $setting);
    ...
    $setting = 'slide6image';
    if (!empty($theme->settings->slide6mage)) {
    	$slideimage = $theme->setting_file_url($setting, $setting);
    } else {
        $slideimage = null;
    }
    ...
    $setting = 'slide7image';
    if (!empty($theme->settings->slide7mage)) {
    	$slideimage = $theme->setting_file_url($setting, $setting);
    } else {
        $slideimage = null;
    }
    ...
    $setting = 'slide8image';
    if (!empty($theme->settings->slide8mage)) {
    	$slideimage = $theme->setting_file_url($setting, $setting);
    } else {
        $slideimage = null;
    }
    ...
    $setting = 'slide9image';
    if (!empty($theme->settings->slide9mage)) {
    	$slideimage = $theme->setting_file_url($setting, $setting);
    } else {
        $slideimage = null;
    }
    $css = theme_nephilamobile_set_slideimage($css, $slideimage, $setting);
     ...
     $setting = 'slide10image';
    if (!empty($theme->settings->slide10mage)) {
    	$slideimage = $theme->setting_file_url($setting, $setting);
    } else {
        $slideimage = null;
    }
    ...
    $css = theme_nephilamobile_set_marketingheight($css, $marketingheight);
    ...
    $css = theme_nephilamobile_set_marketingimage($css, $marketingimage, $setting);
    ...
    $css = theme_nephilamobile_set_fontwww($css);
    return $css;
}

function theme_nephilamobile_set_headingfont($css, $headingfont) {
...
function theme_nephilamobile_set_bodyfont($css, $bodyfont) {
...
function theme_nephilamobile_set_bodysize($css, $bodysize) {
...
function theme_nephilamobile_set_bodyweight($css, $bodyweight) {
...
function theme_nephilamobile_set_themecolor($css, $themecolor) {
...
function theme_nephilamobile_set_themehovercolor($css, $themehovercolor) {
...
function theme_nephilamobile_set_footercolor($css, $footercolor) {
...
function theme_nephilamobile_set_footertextcolor($css, $footertextcolor) {
...
function theme_nephilamobile_set_footerurlcolor($css, $footerurlcolor) {
...
function theme_nephilamobile_set_footerhovercolor($css, $footerhovercolor) {
...
function theme_nephilamobile_set_footerheadingcolor($css, $footerheadingcolor) {
...
function theme_nephilamobile_set_slideheadercolor($css, $slideheadercolor) {
...
function theme_nephilamobile_set_slidecolor($css, $slidecolor) {
...
function theme_nephilamobile_set_slidebuttoncolor($css, $slidebuttoncolor) {
...
function theme_nephilamobile_set_footersepcolor($css, $footersepcolor) {
...
function theme_nephilamobile_set_navbarsep($css, $navbarsep) {
...
function theme_nephilamobile_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_nephilamobile_set_slideimage($css, $slideimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_nephilamobile_set_marketingheight($css, $marketingheight) {
...
function theme_nephilamobile_set_marketingimage($css, $marketingimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_nephilamobile_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->jquery_plugin('cslider', 'theme_nephilamobile');
    $page->requires->jquery_plugin('custom', 'theme_nephilamobile'); 
    $page->requires->jquery_plugin('alert', 'theme_nephilamobile');
    $page->requires->jquery_plugin('carousel', 'theme_nephilamobile');
    $page->requires->jquery_plugin('collapse', 'theme_nephilamobile');
    $page->requires->jquery_plugin('modal', 'theme_nephilamobile');
    $page->requires->jquery_plugin('scrollspy', 'theme_nephilamobile');
    $page->requires->jquery_plugin('tab', 'theme_nephilamobile');
    $page->requires->jquery_plugin('tooltip', 'theme_nephilamobile');
    $page->requires->jquery_plugin('transition', 'theme_nephilamobile');
    $page->requires->jquery_plugin('modernizr', 'theme_nephilamobile');  
    $page->requires->jquery_plugin('jeditable', 'theme_nephilamobile');  
}
