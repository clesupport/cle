<?php
$THEME->name = 'nephilamobile';
$THEME->doctype = 'html5';
$THEME->yuicssmodules = array();
$THEME->parents = array('bootstrapbase');
//$THEME->sheets = array('nephilamobile','slides', 'lightbox', 'font-awesome.min', 'nephila', 'settings','login','dave');
$THEME->sheets = array('slides', 'lightbox', 'categories', 'font-awesome.min', 'essential', 'alternative1', 'alternative2', 'alternative3', 'settings', 'login', 'dave','nephilamobile');
...
$THEME->csspostprocess = 'theme_nephilamobile_process_css';
