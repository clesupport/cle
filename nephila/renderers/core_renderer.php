<?php
class theme_nephila_core_renderer extends theme_bootstrapbase_core_renderer {

   /*
	* Sample for logout button only
	*
	*/ 	
	public function nephila_logout(){
		global $USER;
...
$branchlabel = '<i class="fa fa-files-o"></i> My Achievements';
					       $branchurl   = new moodle_url('/my/index.php');
					       $branchtitle = get_string('myachievements', 'theme_nephila');
					       $branchsort  = 100000;
						
						    $branch = $menu->add($branchlabel, $branchurl, $branchtitle, $branchsort);
						    $branch->add('<em><i class="fa fa-trophy"></i>'.get_string('badges', 'theme_nephila').'</em>',new moodle_url('/badges/view.php', array('type' => 2, 'id' => $COURSE->id)),get_string('badges', 'theme_nephila'));
					       
					       $branchSubMenu = $branch->add('<em><i class="fa fa-files-o"></i>'.get_string('assessmtreport', 'theme_nephila').'</em>',new moodle_url(''),get_string('assessmtreport', 'theme_nephila'));
					       $branchSubMenu->add('<em><i class="fa fa-file"></i>'.get_string('sumassess', 'theme_nephila').'</em>',new moodle_url('/grade/report/user/index.php', array('id' => $COURSE->id)),get_string('sumassess', 'theme_nephila'));
					       $branchSubMenu->add('<em><i class="fa fa-file"></i>'.get_string('subsumassess', 'theme_nephila').'</em>',new moodle_url('/grade/report/overview/index.php', array('id' => $COURSE->id)),get_string('subsumassess', 'theme_nephila'));
					...
					case 'usercoursecreator':
					       ...
					       $branchurl   = new moodle_url('');
					       $branchtitle = get_string('users', 'theme_nephila');
					       $branchsort  = 100000;
						
						    $branch = $menu->add($branchlabel, $branchurl, $branchtitle, $branchsort);
						    $branchSubMenu = $branch->add('<em><i class="fa fa-files-o"></i>'.get_string('accounts', 'theme_nephila').'</em>',new moodle_url(''),get_string('accounts', 'theme_nephila'));
						    $branchSubMenu->add('<em><i class="fa fa-file"></i>'.get_string('browselistofusers', 'theme_nephila').'</em>',new moodle_url('/admin/user.php'),get_string('browselistofusers', 'theme_nephila'));
						    $branchSubMenu->add('<em><i class="fa fa-file"></i>'.get_string('bulkuseraction', 'theme_nephila').'</em>',new moodle_url('/admin/user/user_bulk.php'),get_string('bulkuseraction', 'theme_nephila'));
						    $branchSubMenu->add('<em><i class="fa fa-file"></i>'.get_string('addnewusers', 'theme_nephila').'</em>',new moodle_url('/user/editadvanced.php', array('id' => -1)),get_string('addnewusers', 'theme_nephila'));
						    $branchSubMenu->add('<em><i class="fa fa-file"></i>'.get_string('cohorts', 'theme_nephila').'</em>',new moodle_url('/cohort/index.php'),get_string('cohorts', 'theme_nephila'));
						    $branchSubMenu->add('<em><i class="fa fa-file"></i>'.get_string('uploadusers', 'theme_nephila').'</em>',new moodle_url('/admin/tool/uploaduser/index.php'),get_string('uploadusers', 'theme_nephila'));
						    $branchSubMenu->add('<em><i class="fa fa-file"></i>'.get_string('uploaduserspicture', 'theme_nephila').'</em>',new moodle_url('/admin/tool/uploaduser/picture.php'),get_string('uploaduserspicture', 'theme_nephila'));
						    
						    $branchlabel = '<i class="fa fa-clipboard"></i> Courses';
					       $branchurl   = new moodle_url('');
					       $branchtitle = get_string('courses', 'theme_nephila');
					       $branchsort  = 1000000;
					       
					       $branch = $menu->add($branchlabel, $branchurl, $branchtitle, $branchsort);
					       $branch->add('<em><i class="fa fa-file"></i>'.get_string('managecoursesandcategories', 'theme_nephila').'</em>',new moodle_url('/course/'),get_string('managecoursesandcategories', 'theme_nephila'));
					       $branch->add('<em><i class="fa fa-file"></i>'.get_string('addacategory', 'theme_nephila').'</em>',new moodle_url('/course/editcategory.php', array('parent' => 0)),get_string('addacategory', 'theme_nephila'));
					...
					break;
					       ...
					       //$branchtitle = get_string('logout', 'theme_nephila');
					       //$branchsort  = 100000;
...
class theme_nephila_format_topics_renderer extends format_topics_renderer {
    ...
    protected function get_nav_links($course, $sections, $sectionno) {
        ...
        while ($back > 0 and empty($links['previous'])) {
            if ($canviewhidden || $sections[$back]->uservisible) {
                ...
                $previouslink .= get_string('previoussection', 'theme_nephila');
        ...
        while ($forward <= $course->numsections and empty($links['next'])) {
            if ($canviewhidden || $sections[$forward]->uservisible) {
                ...
                $nextlink .= get_string('nextsection', 'theme_nephila');
