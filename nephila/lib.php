 ...
 */
function theme_nephila_set_fontwww($css) {
    global $CFG, $PAGE;
 ...
 */
function theme_nephila_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_nephila_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @return string
 */
    function nephila_set_pagewidth($css, $pagewidth) {
 ...
 * @return string
 */
function nephila_set_editicons($css, $editicons) {
	global $CFG;
	if (!empty($CFG->themedir)) {
		$editiconsurl = $CFG->themedir . '/nephila/style/editicons.css'; //Pull the full path for autohide css
	} else {
		$editiconsurl = $CFG->dirroot . '/theme/nephila/style/editicons.css'; //MDL-36065
	}
 ...
 * @return string
 */
function nephila_performance_output($param) {
 ...
 */
function nephila_set_customcss($css, $customcss) {
...
function theme_nephila_process_css($css, $theme) {
    ...
    $css = nephila_set_pagewidth($css,$pagewidth);
    ...
    $css = theme_nephila_set_headingfont($css, $headingfont);
    $css = theme_nephila_set_bodyfont($css, $bodyfont);
    $css = theme_nephila_set_bodysize($css, $bodysize);
    $css = theme_nephila_set_bodyweight($css, $bodyweight);
    ...
    $css = theme_nephila_set_themecolor($css, $themecolor);
    ...
    $css = theme_nephila_set_themehovercolor($css, $themehovercolor);
    ...
    $css = theme_nephila_set_footercolor($css, $footercolor);
    ...
    $css = theme_nephila_set_footersepcolor($css, $footersepcolor);
    ...
    $css = theme_nephila_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_nephila_set_footerurlcolor($css, $footerurlcolor);
    ...
    $css = theme_nephila_set_footerhovercolor($css, $footerhovercolor);
...
// Set the footer heading color.
    ...
    $css = theme_nephila_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_nephila_set_slideheadercolor($css, $slideheadercolor);
    ...
    $css = theme_nephila_set_slidecolor($css, $slidecolor);
    ...
    $css = theme_nephila_set_slidebuttoncolor($css, $slidebuttoncolor);
    ...
    $css = theme_nephila_set_navbarsep($css, $navbarsep);
    ...
    $css = nephila_set_editicons($css, $editicons);
    ...
    $css = nephila_set_customcss($css, $customcss);

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_nephila_set_logo($css, $logo);
    
    // Set the background image for the page.
    $setting = 'pagebackground';
    $pagebackground = $theme->setting_file_url($setting, $setting);
    $css = theme_nephila_set_pagebackground($css, $pagebackground, $setting);
    ...
    $css = theme_nephila_set_slideimage($css, $slideimage, $setting);
    ...
    $css = theme_nephila_set_marketingheight($css, $marketingheight);
    ...
    $css = theme_nephila_set_marketingimage($css, $marketingimage, $setting);
    ...
    $css = theme_nephila_set_fontwww($css);
    return $css;
}

function theme_nephila_set_headingfont($css, $headingfont) {
...
function theme_nephila_set_bodyfont($css, $bodyfont) {
...
function theme_nephila_set_bodysize($css, $bodysize) {
...
function theme_nephila_set_bodyweight($css, $bodyweight) {
...
function theme_nephila_set_themecolor($css, $themecolor) {
...
function theme_nephila_set_themehovercolor($css, $themehovercolor) {
...
function theme_nephila_set_footercolor($css, $footercolor) {
...
function theme_nephila_set_footertextcolor($css, $footertextcolor) {
...
function theme_nephila_set_footerurlcolor($css, $footerurlcolor) {
...
function theme_nephila_set_footerhovercolor($css, $footerhovercolor) {
...
function theme_nephila_set_footerheadingcolor($css, $footerheadingcolor) {
...
function theme_nephila_set_slideheadercolor($css, $slideheadercolor) {
...
function theme_nephila_set_slidecolor($css, $slidecolor) {
...
function theme_nephila_set_slidebuttoncolor($css, $slidebuttoncolor) {
...
function theme_nephila_set_footersepcolor($css, $footersepcolor) {
...
function theme_nephila_set_navbarsep($css, $navbarsep) {
...
function theme_nephila_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_nephila_set_slideimage($css, $slideimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_nephila_set_marketingheight($css, $marketingheight) {
...
function theme_nephila_set_marketingimage($css, $marketingimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_nephila_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->jquery_plugin('cslider', 'theme_nephila');
    $page->requires->jquery_plugin('custom', 'theme_nephila'); 
    $page->requires->jquery_plugin('alert', 'theme_nephila');
    $page->requires->jquery_plugin('carousel', 'theme_nephila');
    $page->requires->jquery_plugin('collapse', 'theme_nephila');
    $page->requires->jquery_plugin('modal', 'theme_nephila');
    $page->requires->jquery_plugin('scrollspy', 'theme_nephila');
    $page->requires->jquery_plugin('tab', 'theme_nephila');
    $page->requires->jquery_plugin('tooltip', 'theme_nephila');
    $page->requires->jquery_plugin('transition', 'theme_nephila');
    $page->requires->jquery_plugin('modernizr', 'theme_nephila');  
    $page->requires->jquery_plugin('jeditable', 'theme_nephila');  
}
