...
$string['configtitle'] = 'Nephila';
$string['pluginname'] = 'Nephila';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>Nephila</h2>
<p><img class=img-polaroid src="nephila/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About Nephila</h3>
<p>Nephila is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
